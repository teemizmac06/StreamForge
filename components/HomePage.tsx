...
const ACHS = [
  ...
  {n:'TemmyCreator',plat:'Kick',badge:'aff',label:'Kick Affiliate',days:14,q:'Affiliate in 14 days flat. The group matching put me in front of the right audience.'},
  {n:'CoastalTV',plat:'Twitch',badge:'aff',label:'Twitch Affiliate',days:11,q:'11 days to affiliate. Had 3 viewers before. Now averaging 60+ every stream.'},
  ...
  {n:'IronSight',plat:'Twitch',badge:'aff',label:'Twitch Affiliate',days:9,q:'9 days. The fastest affiliate I have ever heard of. Real viewers make the difference.'},
...
const NOTIFS = [
  {i:'📈',t:'🔥 Marcus just gained +34 followers from a live session',c:'#e8a83e'},
  {i:'👁',t:'CoastalTV hit 380 live viewers tonight',c:'#0891b2'},
  {i:'⚡',t:'TemmyPlays: 60 viewers joined their stream',c:'#f59e0b'},
  {i:'✅',t:'SkylaFPS achieved Twitch Partner status',c:'#16a34a'},
  {i:'🚀',t:'GlitchRex earned Verified badge',c:'#9147ff'},
  {i:'💬',t:'NightOwlTV: chat going — 890 messages sent',c:'#a78bfa'},
  {i:'🎮',t:'IronSight hit affiliate in just 9 days',c:'#53fc18'},
  {i:'🏆',t:'ZaraLive ranked Top 5 in IRL feed',c:'#e8a83e'},
  {i:'💰',t:'PulseGamer landed their first brand deal',c:'#ea580c'},
]
...
const GOALS = [
  ...
  {key:'promo',icon:'📣',title:'Beat Promoters',desc:'Spending on promo with weak results? See why.',msg:"One-time shoutouts don't build real viewers. StreamForge gives you permanent groups."},
...
const HOW = [
  ...
  {n:'03',t:'Real Viewers Join & Interact',d:'Real viewers from the network join your stream, chat and engage — creating momentum that attracts organic discovery.'},
  {n:'04',t:'Track Your Growth',d:'Watch your follower count and viewer numbers climb in your exclusive member analytics dashboard.'},
  ...
  return (
    <div style={{position:'relative',zIndex:1}}>
      ...
      <section className="relative min-h-[95vh] flex items-center justify-center text-center px-5 py-24 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="fade-up-2 font-extrabold tracking-tight leading-[1.08] mb-4 text-4xl sm:text-5xl lg:text-6xl">
            <span className="block" style={{color:'var(--txt)'}}>Get Real Viewers on Your Stream —</span>
            <span className="grad-gold block">Grow Without Bots or Fake Traffic</span>
          </h1>
          ...
          <div className="fade-up-5 flex flex-wrap justify-center gap-8">
            {[['5,800+','Active Members'],['18M+','Views Generated'],['94%','Affiliate Rate'],['3×','Viewer Boost']].map(([n,l])=>(
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 px-5 py-3 border-b" style={{background:'linear-gradient(90deg,transparent,rgba(232,168,62,.04),transparent)',borderColor:'rgba(232,168,62,.15)'}}>
        <div className="flex items-center gap-2 text-sm"><span className="w-2 h-2 rounded-full bg-green-500 live-dot"/><span className="font-extrabold grad-gold">{members}</span><span style={{color:'var(--txt2)'}}>streamers inside right now</span></div>
        <div className="flex items-center gap-2 text-sm"><span>👁</span><span className="font-extrabold grad-gold">{visitors.toLocaleString()}</span><span style={{color:'var(--txt2)'}}>people on this site today</span></div>
        <div className="flex items-center gap-2 text-sm"><span>⚡</span><span className="font-extrabold grad-gold">{apps}</span><span style={{color:'var(--txt2)'}}>applications this week</span></div>
        <div className="text-sm font-bold" style={{color:'var(--ember)'}}>⚠️ Limited spots available this month</div>
      </div>
        ...
        <div className="max-w-3xl mx-auto rv">
          <div className="iphone-card rounded-2xl p-7">
            <div className="flex flex-col gap-5 mb-6">
              {[
                {icon:'🎯',q:'Are you struggling to grow your stream?',a:'Not getting enough viewers, followers, or subscribers?'},
                {icon:'😤',q:'Feeling stuck trying to reach Twitch Affiliate or Partnership?',a:"Wondering why your stream isn't ranking or getting discovered?"},
                {icon:'💸',q:'Tired of wasting money on promotions that don\'t work?',a:'Or trying to build a loyal community but seeing little results?'},
              ].map(item=>(
            ...
            <div className="pt-5 border-t" style={{borderColor:'rgba(232,168,62,.15)'}}>
              ...
              <div className="grid grid-cols-2 gap-2">
                {['🚀 Grow your viewers, followers, and subscribers','🎯 Improve your ranking and dominate your category','🤝 Build a real, loyal fanbase','🏆 Move faster toward Affiliate & Partnership status'].map(b=>(
      ...
      <section className="py-16 px-5 border-b" style={{borderColor:'var(--bdr)',background:'linear-gradient(180deg,rgba(124,58,237,.04),transparent 60%)'}}>
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-start">
          <div className="rv">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight mt-2 mb-6 leading-tight" style={{color:'var(--txt)'}}>Why Most Streamers Stay Stuck at 0 Viewers</h2>
            {[{icon:'😔',t:'Zero discovery',d:'Platforms only recommend streams that already have viewers — a cycle that kills growth before it starts.'},
              ...
              {icon:'💸',t:'Promoters waste money',d:'One-time shoutouts get ghost followers who never watch. Stats stay flat.'},
            ].map(p=>(
          ...
          <div className="rv rv-d2">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight mt-2 mb-6 leading-tight" style={{color:'var(--txt)'}}>A Network That <span className="grad-gold">Actually Works</span></h2>
            {[{t:'Real viewers who actually watch',d:'Every member is a verified real streamer supporting others — genuine engagement, not inflated numbers.'},
              {t:'Consistent visibility every stream',d:'Active groups join your stream consistently, creating engagement signals platforms use to recommend you.'},
      ...
      <section className="py-16 px-5 border-b" id="proof results" style={{borderColor:'var(--bdr)'}}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10 rv">
            ...
            <p className="text-sm mt-2 max-w-xl mx-auto" style={{color:'var(--txt2)'}}>Partner, Affiliate, Top Category, and Income — achieved after joining StreamForge</p>
          </div>
      ...
      <section className="py-16 px-5 border-b" style={{borderColor:'var(--bdr)'}}>
        <div className="max-w-5xl mx-auto rv">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight mt-2" style={{color:'var(--txt)'}}>Stop Paying Promoters. Get Permanent Growth.</h2>
            <p className="text-sm mt-2" style={{color:'var(--txt2)'}}>One-time shoutouts die in hours. StreamForge works every single stream.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-5">
            <div className="iphone-card p-6 rounded-2xl" style={{borderColor:'rgba(220,38,38,.2)'}}>
              <div className="text-base font-bold mb-4 pb-3 border-b" style={{color:'#ef4444',borderColor:'rgba(255,255,255,.07)'}}>❌ Paying a Promoter</div>
              {['One-time shoutout, forgotten in hours','Followers who never actually watch','No accountability, no tracking','No live engagement or real viewers','Keep paying with diminishing returns','Algorithm detects and ignores fake signals'].map(t=>(
            ...
            <div className="iphone-card p-6 rounded-2xl" style={{borderColor:'rgba(232,168,62,.35)',boxShadow:'0 0 30px rgba(232,168,62,.08)'}}>
              ...
              {['Real viewers join and engage when you go live','Members who genuinely watch, chat, and follow','Growth dashboard — track every metric live','Coordinated support at peak live moments','Collab matching, brand deals, verified badge','Algorithm reads real engagement and boosts you'].map(t=>(
                <div key={t} className="flex items-start gap-2 py-2 border-b text-xs" style={{borderColor:'rgba(255,255,255,.04)',color:'var(--txt2)'}}>
      ...
      <section className="py-16 px-5 border-b" style={{borderColor:'var(--bdr)',background:'linear-gradient(180deg,rgba(22,163,74,.03),transparent)'}}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10 rv">
            ...
            <p className="text-sm mt-2" style={{color:'var(--txt2)'}}>No fake reviews. Creators who grew with StreamForge.</p>
          </div>
      ...
      <section className="py-16 px-5 border-b" id="faq" style={{borderColor:'var(--bdr)'}}>
        <div className="max-w-3xl mx-auto rv">
          ...
          {[
            {q:'Is StreamForge safe for my Twitch channel?',a:'Yes. StreamForge uses 100% real human engagement — no bots, no view injection, no automation. Fully compliant with Twitch, Kick and YouTube terms of service.'},
            {q:'Is this fake engagement or viewer bots?',a:'No. Every member is a real verified streamer. They watch, chat and interact because they receive the same support in return. This is a community of real creators.'},
            {q:'How fast can I get Twitch Affiliate?',a:'Our average member achieves Twitch Affiliate in 14 days. Some members hit it in as few as 9 days. Results depend on consistency and streaming schedule.'},
            ...
            {q:'One of your teams contacted me on Discord — is it real?',a:'If Jedidiah, Temmy, levelUpX or Jeremiah reached out, scroll to our Teams section above. Same name, same logo, same handle = verified. Never pay outside contact.streamforge@gmail.com.'},
          ].map((f,i)=>(
      ...
      <section className="py-24 px-5 text-center" id="apply">
        <div className="max-w-2xl mx-auto rv">
          ...
          <h2 className="text-4xl font-extrabold tracking-tight mb-4 grad-txt">Stop Streaming to 0 Viewers</h2>
          <p className="mb-8 leading-relaxed" style={{color:'var(--txt2)'}}>Join 5,800+ streamers who are growing with real engagement, real viewers, and a community that actually shows up.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-4">
            <Link href="/pricing" className="btn-gold px-8 py-4 rounded-xl text-base font-bold no-underline inline-flex items-center justify-center gap-2">🚀 Start Growing Today</Link>
            <button onClick={()=>{const m=document.getElementById('dc-modal');if(m){m.style.display='flex';document.body.style.overflow='hidden'}}}
          ...
          <p className="text-xs" style={{color:'var(--txt3)'}}>No automatic charges · Cancel anytime · Response within 24 hours</p>
        </div>
      </section>
